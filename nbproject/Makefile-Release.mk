...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/client_main.o \
	${OBJECTDIR}/server_main.o
...
${OBJECTDIR}/client_main.o: client_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/client_main.o client_main.cpp

${OBJECTDIR}/server_main.o: server_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/server_main.o server_main.cpp
